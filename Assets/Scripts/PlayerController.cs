...
public class PlayerController : MonoBehaviour
{
	...
	void Update()
	{
		...
		lookAtVec=transform.position+verticalVec*shootJoystick.Vertical+horizontalVec*shootJoystick.Horizontal;
		...
		if (isShootingLeft && Time.time>lastLeftShot+timeBetweenShots)
		{
		...
		else if (!isShootingLeft &&Time.time>lastRightShot+timeBetweenShots)
		{
